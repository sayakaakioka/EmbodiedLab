"""Convert a submission dict or SubmitRequest into a GridWorldSpec."""
...
def convert_submission_to_spec(
    submission: dict[str, Any] | SubmitRequest,
) -> GridWorldSpec:
    """Parse a Firestore submission document or SubmitRequest into a GridWorldSpec."""
    req = (
        submission
